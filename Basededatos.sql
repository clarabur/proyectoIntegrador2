...
INSERT INTO usuarios (id,nombre,apellido,mail,fecha,telefono,contraseña)VALUES (default, "Daira", "Sapir", "dairasapir@gmail.com", "2001-11-20", "1123667492", "Daira2");
INSERT INTO usuarios (id,nombre,apellido,mail,fecha,telefono,contraseña) VALUES (default, "Clara", "Bur" , "clarabur@gmail.com" , "2001/05/10", "1540291928",  "Clara1");
INSERT INTO usuarios (id,nombre,apellido,mail,fecha,telefono,contraseña)VALUES (default, "Cala", "Ruggeri", "calaruggeri@gmail.com", "2001/12/26", "1146897903", "CalaRugg" );
INSERT INTO usuarios (id,nombre,apellido,mail,fecha,telefono,contraseña)VALUES (default, "Agostina", "Cervio", "agoscervio@gmail.com" , "2002/03/17", "1144075773", "Agos2002");
INSERT INTO usuarios (id,nombre,apellido,mail,fecha,telefono,contraseña)VALUES (default, "Lola", "Torres", "lolatorres@gmail.com", "2003/06/18", "114686777", "LolaTorres");
...
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/jeanblanco.jpeg", "Jean offwhite", "Verano 21", "Jean wide leg tiro alto, tejido 100% algodon", "5" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/remera1.webp", "Remera estampada", "Verano 21", "Remera negra con hombreras confeccionada en jersey pima, 100% algodón peruano, de excelente calidad. Escote semi redondo terminado con puño en tela base y hombreras cortas terminadas con costura india, un estilo de puntada diferencial. Diseño de estampa de Bambi, exclusiva de nuestra colección", "3");
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/saco.webp", "Chaleco crop", "Verano 21", "Chaleco crop negro de ultima moda con botones. Tiene bolsillos ocultos en costuras laterales y está completamente forrado en satén con un leve porcentaje de elastano.", "4" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/jean.jpeg", "Jean negro", "Invierno 21", "Jean negro básico de todos los tiempos. Modelo fit al cuerpo y tiro extra alto. 100% algodon.", "1" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/vestido.jpeg", "Vestido negro", "Otoño 21", "Vestido confeccionado en género crepe de satén opaco. Escote en embolsado con forrería de gasa, súper liviana y suave. Mangas largas con terminación de volado en tela combinación de gasa al tono.", "4" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/vestido2.jpeg", "Vestido rosa", "Verano 21", "Vestido de saten rosa largo con espalda totalmente descubierta. Tiene dos tiritas finas que se atan en la espalda y un tajo sobre la pierna derecha.", "2" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/blazer rosa.jpeg", "Blazer rosa", "Verano 21", "Blazer rosa de algodon y corte sastre confeccionado en tejido semi elastizado que aporta excelente calce y comodidad a la prenda. Forrería de mangas de satén opaco con un bajo porcentaje de elastano para acompañar el movimiento del cuerpo y el tejido exterior de la prenda. Forrería de cuerpo con crepe de satén semi brilloso. Silueta entallada y largo por debajo de la cadera. Posee un pequeño bolsillo ojal del lado derecho y dos bolsillos ojales con tapa a los costados de la prenda", "1");
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/camisa azul.webp", "Camisa azul", "Verano 21", "Camisa De Corte Clásico, confeccionada en un material tipo Seda que vuelve a los guardarropas este año con una mezcla de texturas.", "5" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/blanco.webp", "Campera de jean blanca", "Otoño 21", "Campera denim blanca, 100% algodón.", "2" );
INSERT INTO productos (id, image, nombre, temporada, descripcion, usuario_id) VALUES (default, "/images/products/zara.webp", "Campera de jean clasica", "Otoño 21", "Campera denim, 100% algodón.", "3");
